package com.github.app.dify.appaichat.controller;

import com.github.app.dify.appsystemdata.config.DifyConfig;
    ...
    public ResponseEntity<?> listAiApps(
        ...
        try {
            ...
            if (page != null && pageSize != null && page > 0 && pageSize > 0) {
                com.github.app.dify.appcommon.resp.PageResponse<AiAppResp> pageResponse;
                ...
                if (userId != null) {
                    ...
                    pageResponse = new com.github.app.dify.appcommon.resp.PageResponse<>(content, allApps.size(), page, pageSize);
                } else {
                    // 管理员使用分页接口
