...
import com.github.app.dify.appsystemdata.config.FaissConfig;
import com.github.app.dify.appsystemdata.config.MilvusConfig;
...
public class VectorDatabaseServiceImpl implements VectorDatabaseService {
    ...
    @Autowired(required = false)
    private com.github.app.dify.appsystemdata.config.WeaviateConfig weaviateConfig;
