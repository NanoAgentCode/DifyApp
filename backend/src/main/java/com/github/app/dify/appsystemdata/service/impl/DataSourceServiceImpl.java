...
import com.github.app.dify.appsystemdata.repository.DataSourceRepository;
...
import com.github.app.dify.appauth.util.PasswordEncryptionUtil;
...
public class DataSourceServiceImpl implements DataSourceService {
    ...
    public DataSourceResp createDataSource(CreateDataSourceReq req, Long userId, String username, Integer role, Boolean force) {
        ...
        // 验证数据库类型
        try {
            com.github.app.dify.appsystemdata.util.DatabaseDriverManager.DatabaseType.fromString(req.getType());
