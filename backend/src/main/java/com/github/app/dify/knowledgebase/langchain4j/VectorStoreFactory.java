 ...
 * 
 * <p>
 * 负责创建和管理向量数据库的EmbeddingStore实例。根据知识库配置的向量存储类型，
...
public class VectorStoreFactory {
    ...
    private final ConcurrentHashMap<Long, EmbeddingStore<TextSegment>> embeddingStoreCache = new ConcurrentHashMap<>();
        ...
        try {
            ...
            if (knowledgeBaseId != null && knowledgeBaseId == 0L && documentReaderConfig != null) {
                ...
                if (vectorDatabaseId != null && vectorDatabaseRepository != null) {
                    java.util.Optional<com.github.app.dify.knowledgebase.domain.VectorDatabase> config = vectorDatabaseRepository
                            .findById(vectorDatabaseId);
                    if (config.isPresent()) {
            ...
            if (knowledgeBaseRepository != null) {
                ...
                java.util.Optional<com.github.app.dify.knowledgebase.domain.KnowledgeBase> kb = knowledgeBaseRepository
