...
const handleOpenDocument = (row) => {
  router.push(`/admin/document-reader/${row.id}`)
}
...
.document-reader-management :deep(.el-card:hover) {
  box-shadow: var(--card-shadow-hover);
}

.document-reader-management :deep(.el-card__header) {
