  ...
  <div class="workflow-app">
    <el-card class="workflow-container">
      ...
      <div class="workflow-content">
        ...
        />
        <WorkflowExecutionTimeline v-show="isExecuting" :execution-steps="executionSteps" />
...
import { useWorkflowExecutionSteps } from '@/composables/useWorkflowExecutionSteps'
import mammoth from 'mammoth'
import { buildMappedInputs } from '@/utils/difyInputMapping'
import {
  extractWorkflowFiles as extractFiles,
  formatWorkflowResult as formatResult,
  isWorkflowDocx as isDocx,
  isWorkflowHtml as isHtml,
  isWorkflowImage as isImage,
  isWorkflowPdf as isPdf
} from '@/utils/workflowFilePreview'
...
const { processWorkflowEvent, processWorkflowEventThrottled, addExecutionStep, updateExecutionStep } = useWorkflowExecutionSteps(executionSteps)
...
const extractedFiles = computed(() => {
  ...
  return extractFiles(result.value, fileUrlPrefix.value)
})
