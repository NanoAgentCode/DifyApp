    ...
    >
      ...
      >
        ...
        <el-form-item label="向量存储类型" prop="vectorStoreType">
          ...
          <div v-else style="font-size: 12px; color: #909399; margin-top: 5px;">
            Qdrant：分布式向量数据库，适合生产环境。FAISS：本地文件存储，无需额外服务，适合开发测试。Milvus：开源向量数据库，支持大规模向量检索，使用 gRPC 协议。Chroma：开源向量数据库，轻量级，易于部署，支持 HTTP REST API。Weaviate：开源向量数据库，支持 GraphQL 和 REST API，提供强大的语义搜索能力。
          </div>
        </el-form-item>
